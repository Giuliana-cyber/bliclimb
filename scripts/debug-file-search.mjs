  ...
  input: [
    {
      role: "system",
      content:
        "Eres Senda, coach de BilClimb. Usa file_search para consultar la biblioteca antes de responder. No inventes fuentes.",
    },
    {
      role: "user",
      content:
        "Según la biblioteca de BilClimb, ¿cómo debería adaptar entrenamiento de dedos si no tengo hangboard, solo bandas y barra, y tengo dolor 2/10? Responde breve.",
    },
  ],
  tools: [
    {
